                                                                             ...
                                                                             Vector3D<Precision> const &point)
{
  ...
  // First check if in bounding tube
  {
    ...
    HasInnerRadiiTraits<innerRadiiT>::TubeKernels::template Contains<Precision>(
    ...
    const Precision stepMax)
{
  ...
  Precision tubeDistance = 0.;
  {
    ...
    HasInnerRadiiTraits<innerRadiiT>::TubeKernels::template Contains<Precision>(unplaced.fBoundingTube, boundsPoint, inBounds);
    ...
    if (!inBounds) {
      ...
      // the bounds
      HasInnerRadiiTraits<innerRadiiT>::TubeKernels::template DistanceToIn<Precision>(unplaced.fBoundingTube, boundsPoint,
